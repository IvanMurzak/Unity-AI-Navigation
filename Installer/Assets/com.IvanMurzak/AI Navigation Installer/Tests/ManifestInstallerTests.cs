...
namespace com.IvanMurzak.Unity.MCP.Navigation.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/com.IvanMurzak/AI Navigation Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/com.IvanMurzak/AI Navigation Installer/Tests/Files";

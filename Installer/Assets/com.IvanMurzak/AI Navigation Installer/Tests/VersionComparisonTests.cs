...
using com.IvanMurzak.Unity.MCP.Navigation.Installer.SimpleJSON;

namespace com.IvanMurzak.Unity.MCP.Navigation.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/com.IvanMurzak.Unity.MCP.Navigation.Installer.Tests/test_manifest.json";
        const string PackageId = "com.ivanmurzak.unity.mcp.navigation";

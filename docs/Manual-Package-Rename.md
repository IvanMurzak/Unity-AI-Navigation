...
#### 1️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.navigation/package.json`
...
<details>
  ...
  - Update the files:
    - `Packages/com.ivanmurzak.unity.mcp.navigation/Tests/Base/Package.Editor.Tests.asmdef`
    - `Packages/com.ivanmurzak.unity.mcp.navigation/Tests/Base/Package.Tests.asmdef`

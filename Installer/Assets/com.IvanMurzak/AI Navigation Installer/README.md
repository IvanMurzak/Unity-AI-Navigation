...
#### 3️⃣ Customize `Packages/com.ivanmurzak.unity.mcp.navigation/package.json`
...
- 👉 **Delete** `Packages/com.ivanmurzak.unity.mcp.navigation/Tests` folder
...
#### 4️⃣ Add files into `Packages/com.ivanmurzak.unity.mcp.navigation` folder
...
- Copy the updated `README.md` to `Packages/com.ivanmurzak.unity.mcp.navigation` as well.
